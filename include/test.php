...
echo "<pre>";
$table_data = get_table_data("https://prts.wiki/index.php?title=%E5%8D%A1%E6%B1%A0%E4%B8%80%E8%A7%88/%E9%99%90%E6%97%B6%E5%AF%BB%E8%AE%BF&action=edit");
...
function manage_table_data($tableData)
{
  foreach ($tableData as $key => $value) {
    ...
    $table_data_single["id"] = $match[1][0];
    ...
    if ($table_data_single["id"] != "" or $table_data_single["id"] != null) {
      $tableddata[$table_data_single["id"]] = $table_data_single;
    }
  }
  return $tableddata;
}
